...
#clean data
cleandata<-subset(data,Sub_metering_1 !="?" | Sub_metering_2 !="?" | Sub_metering_3 !="?" | Voltage !="?" | Global_reactive_power!="?" | Date != "?")
...
plot(dates,as.numeric(cleandata$Voltage), 
     ylab="Voltage", 
     xlab="datetime",
     type='l')
...
plot(dates,as.numeric(cleandata$Global_reactive_power), 
